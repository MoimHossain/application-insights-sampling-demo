...
{
    public class ExemplificationWorker : BackgroundService
    {
        private readonly ILogger<ExemplificationWorker> _logger;
        private TelemetryConfiguration configuration;
        private static HttpClient http = new HttpClient();


        public ExemplificationWorker(ILogger<ExemplificationWorker> logger)
        {
            _logger = logger;
            configuration = TelemetryConfigurationExtensions.CreateConfiguration().ConfigureWithExemplification();
        }
