...
{
    public class FilteringWorker : BackgroundService
    {
        private readonly ILogger<FilteringWorker> _logger;
        private TelemetryConfiguration configuration;
        private static HttpClient http = new HttpClient();
        
        public FilteringWorker(ILogger<FilteringWorker> logger)
        {
            _logger = logger;
            configuration = TelemetryConfigurationExtensions.CreateConfiguration().ConfigureWithFiltering();
        }
